...
copy /Y "..\python_base_includes\firebase_updater\firebase_updater.py" includes\
...
copy /Y "..\dgnet_watchdog_gae_p3_recording_includes\usage_recording_include.py" includes\
