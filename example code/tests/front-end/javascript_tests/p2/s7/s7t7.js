...
var request_time = 0;
var request_url = configs.base_domain_url + "/json-requests/p2s7t7-assign-notification-rule";

var params = {
    p2s7_firebase_email: configs.user_email,
    p2s7_token: '',
    p2s7t7_rule_uid: "28-e84lTGBgHsdUOioj8X1i-2020-01-01-07-34-45-826795",
    p2s7t7_rule_type: '1',
    p2s7t7_object_attribute_uid: "obj_atr_277-341",
    p2s7t7_notification_type: "c",
    p2s7t7_retrigger_time: 600
};
