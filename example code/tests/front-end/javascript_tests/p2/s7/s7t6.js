...
var request_time = 0;
var request_url = configs.base_domain_url + "/json-requests/p2s7t6-delete-notification-rule";

var params = {
    p2s7_firebase_email: configs.user_email,
    p2s7_token: '',
    p2s7t6_rule_type: "1",
    p2s7t6_rule_uid: "28-QsdpWx5uKBosWbUFUi1j-2020-01-01-07-45-13-474381"
};
