...
var request_time = 0;
var request_url = configs.base_domain_url + "/web-commands/p2s9t6-remove-rule-from-notification-group";

var params = {
    p2s9_firebase_email: configs.user_email,
    p2s9_token: '',
    p2s9t6_ngp_uid: "39",
    p2s9t6_rule_uid: "39-1-XN4yJwgpgvJO9hMLA8Bd-2019-10-08-03-31-57-865956"
};
