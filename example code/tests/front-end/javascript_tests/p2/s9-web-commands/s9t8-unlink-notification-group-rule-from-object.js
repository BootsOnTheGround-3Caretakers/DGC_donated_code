...
var request_time = 0;
var request_url = configs.base_domain_url + "/web-commands/p2s9t8-unlink-notification-group-rule-from-object";

var params = {
    p2s9_firebase_email: configs.user_email,
    p2s9_token: '',
    p2s9t8_ngp_uid: "39",
    p2s9t8_rule_uid: "39-1-wqbtRZWK5GDut1xVk5ao-2019-10-08-04-01-59-988619",
    p2s9t8_object_uid: "obj_1108",
    p2s9t8_attribute_uid: "obj_attr_6"
};
