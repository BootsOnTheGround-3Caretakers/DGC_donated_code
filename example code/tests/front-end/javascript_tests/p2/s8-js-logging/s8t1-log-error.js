...
var request_time = 0;
var request_url = "https://js-logging-dot-dev-watchdog-user-interface.appspot.com/js-logging/p2s8t1-log-error";

var params = {
    p2s8_firebase_email: configs.user_email,
    p2s8_token: '',
    p2s8t1_user_uid: configs.user_uid.replace("usr_", ""),
    p2s8t1_operation_id: "1",
    p2s8t1_operation_name: "Operation 1",
    p2s8t1_return_msg: "Error 1",
    p2s8t1_success_code: "0",
    p2s8t1_debug_data: "Debug Data 1"
};
